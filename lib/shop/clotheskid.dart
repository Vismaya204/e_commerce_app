...
class Clotheskid extends StatefulWidget {
  const Clotheskid({super.key});

  @override
  State<Clotheskid> createState() => _ClotheskidState();
}

class _ClotheskidState extends State<Clotheskid> {
  @override
  ...
  stream: FirebaseFirestore.instance
      .collection('products')
      .where('category', isEqualTo: 'Clothes').where('gender', isEqualTo: 'Kid') // ✅ Filter by category only
      .snapshots(),
