...
class Men_new extends StatefulWidget {
  const Men_new({super.key});

  @override
  State<Men_new> createState() => _Men_newState();
}

class _Men_newState extends State<Men_new> {
  @override
        ...
        child: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            final filteredProducts = allProducts.where((doc) {
              ...
              return data['gender'] == 'Men'; // ✅ Case-sensitive
            }).toList();
