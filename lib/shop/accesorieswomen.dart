...
class Accesorieswomen extends StatefulWidget {
  const Accesorieswomen({super.key});

  @override
  State<Accesorieswomen> createState() => _AccesorieswomenState();
}

class _AccesorieswomenState extends State<Accesorieswomen> {
  @override
  ...
  stream: FirebaseFirestore.instance
      .collection('products')
      .where('category', isEqualTo: 'Accessories').where('gender', isEqualTo: 'Women') // ✅ Filter by category only
      .snapshots(),
