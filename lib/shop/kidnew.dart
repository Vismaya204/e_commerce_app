...
class Kidnew extends StatefulWidget {
  const Kidnew({super.key});

  @override
  State<Kidnew> createState() => _KidnewState();
}

class _KidnewState extends State<Kidnew> {
  @override
      ...
      body: Padding(
        ...
        child: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            // ✅ Filter by gender in Dart (no index needed)
            final allProducts = snapshot.data!.docs;
            final filteredProducts = allProducts.where((doc) {
              final data = doc.data() as Map<String, dynamic>;
              return data['gender'] == 'Kid'; // ✅ Case-sensitive
            }).toList();
            ...
            return GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final productfetch = Product( id: allProducts[index].id,
