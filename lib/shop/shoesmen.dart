...
class Shoesmen extends StatefulWidget {
  const Shoesmen({super.key});

  @override
  State<Shoesmen> createState() => _ShoesmenState();
}

class _ShoesmenState extends State<Shoesmen> {
  @override
  ...
  stream: FirebaseFirestore.instance
      .collection('products')
      .where('category', isEqualTo: 'Shoes').where('gender', isEqualTo: 'Men') // ✅ Filter by category only
      .snapshots(),
