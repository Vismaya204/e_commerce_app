...
class Clothesmen extends StatefulWidget {
  const Clothesmen({super.key});

  @override
  State<Clothesmen> createState() => _ClothesmenState();
}

class _ClothesmenState extends State<Clothesmen> {
  @override
  ...
  stream: FirebaseFirestore.instance
      .collection('products')
      .where('category', isEqualTo: 'Clothes').where('gender', isEqualTo: 'Men') // ✅ Filter by category only
      .snapshots(),
